...
po::options_description ProgramOptions::createDefaultOptions()
{
    ...
    if (!descriptionInitialized)
    {
        ...
        desc.add_options()
            ...
            ("videocodec,v", po::value<string>(), "videocodec (mpeg4,h263,h264,theora)")
            ("audiocodec,a", po::value<string>(), "audiocodec (raw,vorbis,mp3)")
            ...
            ("audioport,t", po::value<int>(), "audioport number (1024-60000)")
            ("videoport,p", po::value<int>(), "videoport number (1024-60000)")
            ...
            ("numchannels,c", po::value<int>()->default_value(1), "number of audio channels")
