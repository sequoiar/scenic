...
class MivilleProcess(Process):
    ...
    def make_command(self):
        # TODO: This is really weird that we have to use the ../ path
        return "../mivilled -o %s -m %s -C" % (self.port_offset, os.path.expanduser(self.miville_home))
