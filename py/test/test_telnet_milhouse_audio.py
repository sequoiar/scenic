...
#    
    ...
    def test_05_audio_send_receiv(self):
        ...
        rx_init_cmd = "audio_init:" + self._get_start_command('raw', 12005, "127.0.0.1")
        verb( "RX:>" + rx_init_cmd)
        tx_init_cmd =  "audio_init:" + self._get_start_command ('raw', 12005, "127.0.0.1", source=audio_src, channels=2)
        verb( "TX:>" + tx_init_cmd)
        ...
        self._stream_duration(15.)
        # cleanup and go home
        verb("stopping the streaming...")
 
 
        self.tst_tx("stop:", stop_ok) # CARAMBA!
    ...
    def test_06_audio_video_synchronized(self): 
        ...
        self._stream_duration(5.)
        # check number of packets TBD
        self.tst_rx("stop:", stop_ok) # CARAMBA!!!
