...
class Test_001_network_streaming(testing.TelnetBaseTest):
    ...
    def test_01_yes(self):
        ...
        self.tst('settings --type media --mediasetting media_tc1  --modify settings=service:Gst'            , 'modified')
...
################################transmit settings####################################################
        ...
        self.tst("settings --type stream --globalsetting vid_rxtx_oneway_setting --subgroup send --mediastream video01 --modify port=6699", "modified")        
        ...
        #d -a -k video -t v4l2 -d /dev/video0
