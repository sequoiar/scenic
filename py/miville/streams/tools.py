...
class StreamerProblem(object):
    ...
    """
    def __init__(self, error_code, message, details=u''):
        self.error_code = error_code
        self.message = message
        self.details = details

    def __str__(self):
        return '%s: %s %s' % (self.error_code, self.message, self.details)
...
#    
#    def __init__(self, name="default", log_max_size=100, command=None, verbose=False, process_protocol_class=ManagedProcessProtocol, check_delay=2.0, env=None):
#        """
...
#        self.start_error_signal = sig.Signal() 
#        self.stop_error_signal = sig.Signal() 
#        self.crashed_signal = sig.Signal() 
#        self.start_success_signal = sig.Signal() 
#        self.stop_success_signal = sig.Signal() 
...
#            self.start_success_signal()  # no data
...
#            self.start_error_signal(err_msg)
...
#            self.stop_success_signal("stop_success")
...
#            #self.subject.notify(None, err_msg, "stop_error")
#            self.stop_error_signal(err_msg)
